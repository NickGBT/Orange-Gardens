...
@NamedQueries({
		@NamedQuery(name = "FindByCriticalThreshold", query = "SELECT a FROM stock WHERE a.critical_stock = :critical_stock"),
...
public class StockManagerDB implements StockManager {
	...
	public List<Stock> findByCriticalThreshold(int criticalThreshold) {
		...
		EntityManager em = pm.createEntityManager();
		TypedQuery<Stock> tq = em.createNamedQuery("FindByCriticalThreshold",
				Stock.class);
		pm.closeEntityManager(em);
	...
	public List<Stock> findByRequiredStock(int requiredStock) {
		...
		EntityManager em = pm.createEntityManager();
		TypedQuery<Stock> tq = em.createNamedQuery("FindByRequiredStock",
				Stock.class);
		pm.closeEntityManager(em);
	...
	public List<Stock> findByStockLevel(int stockLevel) {
		List<Stock> stock = new ArrayList<Stock>();
		EntityManager em = pm.createEntityManager();
		TypedQuery<Stock> tq = em.createNamedQuery("FindByStockLevel",
				Stock.class);
		pm.closeEntityManager(em);
	...
	public List<Stock> findByStockAvailable(int stockAvailable) {
		List<Stock> stock = new ArrayList<Stock>();
		EntityManager em = pm.createEntityManager();
		TypedQuery<Stock> tq = em.createNamedQuery("FindByStockAvailable",
				Stock.class);
		pm.closeEntityManager(em);
	...
	public List<Stock> findByMaximumStock(int maxStock) {
		List<Stock> stock = new ArrayList<Stock>();
		EntityManager em = pm.createEntityManager();
		TypedQuery<Stock> tq = em.createNamedQuery("FindByMaxStock",
				Stock.class);
		pm.closeEntityManager(em);
	...
	public List<Stock> getStock() {
		EntityManager em = pm.createEntityManager();
		List<Stock> stock = (ArrayList<Stock>) em.createQuery(
				"SELECT a FROM stock a", Stock.class).getResultList();
		pm.closeEntityManager(em);
		return stock;
	}
