...
public class CatalogController {
	 ...
	 * productManager.populateProducts(); productsInCatalog =
	 * (ArrayList<Product>) productManager.getAll(); return productsInCatalog; }
	 */
	...
	/*
	 * public ArrayList<Product> getProductsInCatalog(ProductCategory
	 * productCategory) { if (productCategory == null) {
	 * productManager.populateProducts(); productsInCatalog =
	 * (ArrayList<Product>) productManager.getAll(); } else { productsInCatalog
	 * = (ArrayList<Product>) productManager.findByCategory(productCategory); }
	 * 
	 * return productsInCatalog; }
	 */

	/*
	 * @RequestMapping(value = "/catalog", method = RequestMethod.GET) public
	 * String displayCatalogPage(Model model) {
	 * System.out.println("/catalouge"); ArrayList<Product> productsInCatalog =
	 * new ArrayList<Product>(); //productManager.populateProducts();
	 * productsInCatalog = (ArrayList<Product>) productManager.getAll();
	 * model.addAttribute("items", productsInCatalog);
	 * System.out.println(productsInCatalog.size()); return "items"; }
	 */
}
