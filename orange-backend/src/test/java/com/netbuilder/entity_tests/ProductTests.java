...
public class ProductTests {
	...
	/*
	 * @Test public void testUnderlengthName(){ String testName = "a";
	 * 
	 * testProduct.setProductName(testName);
	 * 
	 * assertTrue("Name requires length control. Length is: " +
	 * testProduct.getProductName().length()
	 * ,testProduct.getProductName().length() >= 4); }
	 * 
	 * @Test public void testOverlengthName(){ String testName = "a";
	 * 
	 ...
	 * 
	 * @Test public void testNullName(){ testProduct.setProductName(null);
	 * 
	 * assertTrue("productName has been allowed to be null.",
	 * testProduct.getProductName() != null); }
	 * 
	 * @Test public void testOverlengthDescription(){ String testString = "a";
	 * for(int i = 0; i < 1001; i++) testString = testString + "a";
	 * 
	 * testProduct.setDescription(testString);
	 * 
	 * assertTrue("The test string length should be cropped in Product. It is "
	 * + testProduct.getDescription().length()
